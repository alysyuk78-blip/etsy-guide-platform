    ...
    <div>
      ...
      <header className="px-6 pb-16 pt-10 sm:px-12 sm:pt-14 lg:px-20 lg:pt-16">
        ...
        <p className="rise rise-3 mt-10 max-w-[620px] text-[16px] leading-[1.65] text-ink-soft sm:mt-14 sm:text-[19px]">
          ...
          України. Не на чиємусь особистому досвіді. Кожне твердження промарковане джерелом: офіційна policy або
          рекомендація Etsy, перевірювані дані чи практична евристика.
        </p>
        ...
        <Reveal delay={80}>
          <div className="card-lift mt-6 overflow-hidden rounded-2xl bg-paper-deep">
            {[
              ...
              ["Метод", "Трирівневе маркування: [Etsy] — офіційна policy або рекомендація Seller Handbook (визначається контекстом і джерелом), [Дані] — перевірювані дані та роз’яснення держорганів, [Практика] — робоча евристика, а не правило Etsy"],
